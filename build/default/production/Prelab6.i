...
INT_TMR1:
    ...
    BTFSC ((STATUS) and 07Fh), 2 ;Verificamos la bandera
    CLRF SEGUNDO2 ;Se reseata si esta encendida la bandera
    RETURN

INT_TMR2:
    BCF ((PIR1) and 07Fh), 1 ; Limpiamos bandera de interrupcion de TMR2
...
CONFIG_TMR1:
    ...
    BSF ((T1CON) and 07Fh), 5 ; Prescaler 2:0
...
CONFIG_TMR2:
    ...
    BSF ((T2CON) and 07Fh), 1 ; Prescaler 1:0
    BSF ((T2CON) and 07Fh), 0

    BSF ((T2CON) and 07Fh), 6 ;Postscaler 16:0
